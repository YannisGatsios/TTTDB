...
import com.database.tttdb.api.Functions.*;
...
public class FunctionsTest {
    ...
    void testGetFromFunction_allOperations_Integer() throws Exception {
        ...
        Object resultNumber = new operationData(expression).apply(new com.database.tttdb.core.table.TableSchema("tableName",schema.getColumns()), row, 0);
    ...
    void testGetFromFunction_simpleExpression() throws Exception {
        ...
        Object result = new operationData(expression).apply(new com.database.tttdb.core.table.TableSchema("tableName",schema.getColumns()), row, 0);
        assertNotNull(result);
    ...
    void testGetFromFunction_nullExpression() throws Exception {
        ...
        Object[] row = { 1, 2 };
        Object result = new operationData(null).apply(new com.database.tttdb.core.table.TableSchema("tableName",schema.getColumns()), row, 0);
        assertNull(result);
    }
